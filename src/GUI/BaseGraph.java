...
public class BaseGraph extends JPanel implements IGraph
{
	//private field
	int node;	
	int x;
	...
	public BaseGraph() {
		...
		Frame = new JFrame("Grapp");
		Frame.show();
	}
	
	public BaseGraph(int _node, int _x, int _y) {
		// TODO Auto-generated constructor stub
		node = _node;
		x = _x;
		y = _y;
		dataNode = new double[x][y];
	...
	public void setNodeData(double[][] _dataNode)
	{
		dataNode = _dataNode;
	}
	
	public void data2Node()
	{
